...
<body>
    <form action="<?= base_url('save') ?>" method="post" style="max-width: 400px; margin: 0 auto; text-align: center; padding: 20px; border: 1px solid #ccc; border-radius: 5px; background-color: #f9f9f9;">
        <label style="display: block; text-align: left; margin-bottom: 5px;">Student Registration</label>
        ...
        <select name="StudSection" id="StudSection" style="width: 100%; padding: 8px; margin-bottom: 10px;">
