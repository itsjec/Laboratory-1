...
--
-- Host: localhost:3306
-- Generation Time: Sep 21, 2023 at 10:46 AM
...
(2, 'Marc Danielle Cabatay', 'Male', 'Application Development', 'F2', 'Third Year'),
(3, 'Jessica M. Ramos', 'Female', 'Information Management', 'F2', 'Third Year');
...
--
ALTER TABLE `table_students`
  MODIFY `StudID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
