...
--
-- Host: localhost:3306
-- Generation Time: Sep 22, 2023 at 03:00 PM
...
(5, 'Marc Danielle Cabatay', 'Male', 'Information Management', 'F2', 'Third Year'),
(8, 'Marc Cabatay', 'Male', 'BSIT', 'F2', 'Third Year');
...
--
ALTER TABLE `table_students`
  MODIFY `StudID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
